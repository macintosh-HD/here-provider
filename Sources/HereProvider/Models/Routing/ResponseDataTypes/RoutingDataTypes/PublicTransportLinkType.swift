...
public class PublicTransportLinkType: RouteLinkType {
    ...
    override init(linkId: LinkIdType, shape: GeoPolylineType?, firstPoint: Int?, lastPoint: Int?, length: DistanceType?, remainDistance: DistanceType?, remainTime: DurationType?, nextLink: LinkIdType?, maneuver: ElementReferenceType?, timeDependentRestrictionRef: Int?, nextStopName: String?, line: ElementReferenceType?) {
